...
from langchain_text_splitters.markdown import ExperimentalMarkdownSyntaxTextSplitter, MarkdownTextSplitter
...
class MarkdownChunker(BaseChunker):
    ...
    def chunk(self, input_string):
        ...
        md_splitter = MarkdownTextSplitter(chunk_size=self.chunk_size, chunk_overlap=self.chunk_overlap)
